...
export type GetProjectsResult = {
  ...
  description: string;
  /**
   * This flag indicates is analytics tracking enabled by `matyan up` command or not
   */
...
export type GetParamsResult = {
   ...
   * This generates by calling
   * ```python
   *    run.track([, , , matyan.Image(...)], name="labels", context = {"subset": "test"})
   *    run.track([, , , matyan.Image(...)], , context = {"subset": "val"})
   * ```
   ...
   * This generates by calling
   * ```python
   *    run.track([, , , matyan.Text(...)], name="...", context = {"subset": "test"})
   * ```
   */
   ...
   * This generates by calling
   * ```python
   *    run.track([, , , matyan.Figure(...)], name="...", context = {"subset": "test"})
   * ```
   */
   ...
   * This generates by calling
   * ```python
   *    run.track([, , , matyan.Distribution(...)], name="...", context = {"subset": "test"})
   * ```
   */
   ...
   * This generates by calling
   * ```python
   *    run.track([, , , matyan.Audio(...)], name="...", context = {"subset": "test"})
   * ```
   */
...
export type GetProjectContributionsResult = {
  /**
   * Total number of experiments in a single repo/storage/project (.matyan directory)
   */
  num_experiments: number;
  /**
   * Total number of archived runs in a single repo/storage/project (.matyan directory)
   */
  num_archived_runs: number;
  /**
   * Total number of runs in a single repo/storage/project (.matyan directory)
   */
  num_runs: number;
  /**
   *  Number of active runs in a single repo/storage/project (.matyan directory)
   */
