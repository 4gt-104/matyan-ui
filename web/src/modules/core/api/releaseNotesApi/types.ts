...
export interface IReleaseNote {
   ...
   * @type {string}
   * @example 'https://api.github.com/repos/matyan-core/matyan-core/releases/76800801'
   */
  url: string;
  /**
  ...
  assets: [];
  /**
   * @description The gzip file download url of that version of Matyan.
   * @type string
   */
  tarball_url: string;
  /**
   * @description The zip file download url of that version of Matyan.
   * @type string
   */
  zipball_url: string;
  /**
