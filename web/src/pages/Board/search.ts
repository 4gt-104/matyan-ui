...
const objectDepths = {
  [SequenceTypesEnum.Metric]: MatyanObjectDepths.Sequence,
  [SequenceTypesEnum.Images]: MatyanObjectDepths.Index,
  [SequenceTypesEnum.Audios]: MatyanObjectDepths.Index,
  [SequenceTypesEnum.Figures]: MatyanObjectDepths.Step,
  [SequenceTypesEnum.Texts]: MatyanObjectDepths.Index,
  [SequenceTypesEnum.Distributions]: MatyanObjectDepths.Index,
};
