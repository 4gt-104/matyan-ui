...
function RunDetailSettingsTab({
  ...
  function onRunFinish() {
    runDetailAppModel.finishRun(runHash);
  }
      ...
      <div className='RunDetailSettingsTab'>
        <div className='RunDetailSettingsTab__actionCardsCnt'>
          ...
          {isActive && (
            <ActionCard
              title='Stop Run'
              description='Mark this run as finished. Use this if the run process crashed or was killed.'
              btnTooltip='Stop Run'
              btnText='Stop'
              onAction={onRunFinish}
              btnProps={{
                variant: 'outlined',
                className: 'RunDetailSettingsTab__actionCardsCnt__btn__archive',
              }}
            />
          )}
          <ActionCard
