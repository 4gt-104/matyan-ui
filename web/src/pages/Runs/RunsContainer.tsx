...
import { RUNS_TABLE_SORT_OPTIONS } from 'services/models/explorer/runsModelMethods';
  ...
  return (
    <ErrorBoundary>
      <Runs
        ...
        sortFields={runsData?.config?.table?.sortFields ?? []}
        sortOptions={RUNS_TABLE_SORT_OPTIONS}
        onSortChange={runsAppModel.onSortChange}
        onSortReset={runsAppModel.onSortReset}
        ...
        finishRuns={runsAppModel.finishRuns}
