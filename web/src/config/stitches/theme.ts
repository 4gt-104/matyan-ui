...
export const lightTheme: ConfigType.Theme = {
  colors: {
    ...
    'primary-dark': '#00796B',
    'primary-bold': '#00897B',
    'primary-plain': '#009688',
    'primary-soft': '#4DB6AC',
    'primary-light': '#B2DFDB',
    'primary-airly': '#E0F2F1',
    // secondary colors
    secondary10: '#E2E6ED',
    secondary20: '#E2E6ED',
    secondary30: '#D4DAE3',
    ...
    // background primary colors (teal)
    'background-active-primary-dark': '#00796B',
    'background-hover-primary-bold': '#00897B',
    'background-default-primary-plain': '#009688',
    'background-focus-primary-plain': '#009688',
    'background-focus-primary-soft': '#4DB6AC',
    'background-disable-primary-soft': '#4DB6AC',
    'background-active-primary-light': '#B2DFDB',
    'background-hover-primary-airly': '#E0F2F1',
    'background-focus-primary-airly': '#E0F2F1',
    ...
    'background-focus-secondary-plain': '#009688',
    'background-focus-secondary-soft': '#4DB6AC',
    ...
    // ------------------border-colors------------------
    // ------------------border-base-colors------------------
    // border primary colors (teal)
    'border-active-primary-dark': '#00796B',
    'border-hover-primary-bold': '#00897B',
    'border-default-primary-plain': '#009688',
    'border-focus-primary-soft': '#4DB6AC',
    'border-disable-primary-soft': '#4DB6AC',
    'border-active-primary-light': '#B2DFDB',
    'border-focus-primary-airly': '#B2DFDB',
    ...
    'border-focus-secondary-soft': '#4DB6AC',
    'border-disable-secondary-soft': '#9D9EA1',
    'border-active-secondary-light': '#B2DFDB',
    'border-focus-secondary-airly': '#B2DFDB',
    // border text colors
    ...
    // ------------------text-colors------------------
    // text primary colors (teal)
    'text-active-primary-dark': '#00796B',
    'text-hover-primary-bold': '#00897B',
    'text-default-primary-plain': '#009688',
    'text-focus-primary-plain': '#009688',
    'text-disable-primary-soft': '#4DB6AC',
    ...
    // ------------------icon-colors------------------
    // icon primary colors (teal)
    'icon-active-primary-dark': '#00796B',
    'icon-hover-primary-bold': '#00897B',
    'icon-default-primary-plain': '#009688',
    'icon-focus-primary-plain': '#009688',
    'icon-disable-primary-soft': '#4DB6AC',
    // icon text colors
