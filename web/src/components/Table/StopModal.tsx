...
function StopModal({
  ...
  const { data, disabledData } = React.useMemo(() => {
    ...
    activeList = _.orderBy(activeList, ['creationTime'], ['desc']);
  ...
  return opened ? (
    <Modal
      ...
      okButtonText='Stop'
      title='Are you sure you want to stop the selected runs?'
      modalType='error'
      titleIconName='close-circle'
      maxWidth='lg'
    ...
    >
      <div className='ActionModal'>
        ...
        >
          Stopped runs will be marked as finished. Use this for runs whose
