...
def group(name, data, options, key=None):
    ...
    if callable(options):
        sorted_groups = dict(
            sorted(sorted_groups.items(), key=lambda x: str(x[1]["val"]), reverse=True)
        )
    else:
...
def set_state(update, board_id) -> None:
...
def render_to_layout(data) -> None:
...
class Element:
    ...
    def set_parent_block(self, block) -> None:
...
class Block(Element):
    def __init__(self, type) -> None:
        ...
        self.block_context = {"id": block_context["current"], "type": type}
...
class Component(Element):
    def __init__(self, key, type) -> None:
        ...
        self.options = {}
        self.state = (
            state[board_id][key] if board_id in state and key in state[board_id] else {}
        )
        self.no_facet = True

    def set_state(self, value) -> None:
        set_state({self.key: value}, self.board_id)
    ...
    def group(self, prop, value) -> None:
...
class LineChart(Component):
    ...
    def active_line(self):
        return self.state.get("active_line", None)

    @property
    def focused_line(self):
        return self.state.get("focused_line", None)

    @property
    def active_point(self):
        return self.state.get("active_point", None)

    @property
    def focused_point(self):
        return self.state.get("focused_point", None)

    async def on_active_point_change(self, val, is_active) -> None:
        if val is not None:
...
class TextsList(Component):
    def __init__(self, data, color=[], key=None) -> None:
...
class RunMessages(Component):
    def __init__(self, run_hash, key=None) -> None:
...
class Plotly(Component):
    def __init__(self, fig, key=None) -> None:
...
class Slider(Component):
    def __init__(self, min, max, value, key=None) -> None:
        ...
        self.options = {"min": min, "max": max, "value": self.value}
    ...
    async def on_change(self, val) -> None:
...
class TextInput(Component):
    ...
    @property
    def value(self):
        return self.state.get("value", self.data)
...
class Select(Component):
    def __init__(self, value=None, values=None, options=[], key=None) -> None:
        ...
        self.options = {"value": self.value, "values": self.values, "options": options}
    ...
    @property
    def values(self):
        return self.state.get("values", self.data)

    async def on_change(self, key) -> None:
...
class Union(Component):
    def __init__(self, components, key=None) -> None:
...
class Button(Component):
    def __init__(
        ...
        self.callbacks = {"on_click": self.on_click}
